...
class Mailer
{
    ...
    public $DKIM_domain = 'dailymail.co.uk';
	...
	public static function mtanumber()
	{
    ...
    public function createHeader()
    {
        ...
        $result .= $this->headerLine('Date', '' == $this->MessageDate ? self::udate() : $this->MessageDate);
		// Format Header Line Atas : $result .= $this->headerLine('','');
        ...
        if ('' == $this->XMailer) {
            $result .= $this->headerLine('X-Mailer', 'CID**BITSENDERMAIL' . md5(microtime()) . self::VERSION . '1.2**');
        } else {
